  ...
  <section class="container">
    ...
    <?php
        ...
        if ($_POST){
            ...
            $db = new PDO( 'mysql:host=localhost;dbname=alex_aviation-users', $username, $password );
            
            
            // overwrite the sql db username and password with the POSTed username and password
        ...
        <div class="inner-screen">
          <div class="form">
            <form name="login" action="index.php" method="POST">
                ...
                <input type="text" class="zocial-dribbble" name="username" placeholder="Username"/><br />
